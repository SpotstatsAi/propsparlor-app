...
export async function onRequest(context) {
  ...
  if (!Number.isInteger(seasonNum) || seasonNum < 1979) {
    // 1979+ is where modern 3-point era starts; adjust later if needed.
    return errorResponse(
      400,
      "BAD_REQUEST",
  ...
  // player_ids[] is the standard array parameter used in the multisport spec
  ...
  // Normalize key stats into a clean object. We keep BDL field names where possible.
  const clean = {
